...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { service_order_id: @share.service_order_id, shared_with_id: @share.shared_with_id }
    end
  ...
  test "should update share" do
    put :update, id: @share, share: { service_order_id: @share.service_order_id, shared_with_id: @share.shared_with_id }
    assert_redirected_to share_path(assigns(:share))
  end
